...
aws eks list-access-entries   --cluster-name challenge-dev-cluster
...
kubectl config use-context arn:aws:eks:eu-west-2:996099991204:cluster/challenge-dev-cluster
